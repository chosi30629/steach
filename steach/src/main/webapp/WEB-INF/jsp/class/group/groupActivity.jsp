...
//         var fileTarget = $('.upload-hidden'); 
        ...
        $(document).on('change', '.upload-hidden', function() { 
            ...
            for(let j = 0; j < filenames.length; j++) {
            	upload.siblings('.upload-name').append('<h5>' + filenames[j] + '</h5>'); 
            }
            filenames = [];
        }); 
